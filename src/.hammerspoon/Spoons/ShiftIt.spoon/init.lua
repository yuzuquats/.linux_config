...
local units = {
  ...
  center34      = { x = 0.33, y = 0.00, w = 0.34, h = 1.00 },
...
function obj:left() move(units.left33, nil, true, 0) end
function obj:right() move(units.right33, nil, true, 0) end
function obj:left50() move(units.left50, nil, true, 0) end
function obj:right50() move(units.right50, nil, true, 0) end
function obj:left67() move(units.left67, nil, true, 0) end
function obj:right67() move(units.right67, nil, true, 0) end
function obj:up() move(units.center34, nil, true, 0) end
...
function obj:bindHotkeys(mapping)
  ...
  hs.hotkey.bind(self.mapping.left50[1], self.mapping.left50[2], function() self:left50() end)
  hs.hotkey.bind(self.mapping.right50[1], self.mapping.right50[2], function() self:right50() end)
  hs.hotkey.bind(self.mapping.left67[1], self.mapping.left67[2], function() self:left67() end)
  hs.hotkey.bind(self.mapping.right67[1], self.mapping.right67[2], function() self:right67() end)
